package com.deedeveloper.resume.cv;
...
public class CVFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        items = new ArrayList<>();
        items.add(new CVItem("20 April 2013",getString(R.string.summary)));
        items.add(new CVItem("20 May 2013",getString(R.string.lorem_text2)));
        items.add(new CVItem("25 July 2013",getString(R.string.summary)));
